        ...
        <main>
          ...
          <div class="update">
            ...
            <?php
                  ...
                  $sql="SELECT * FROM turniri INNER JOIN coordinator_table on turniri.id_koordinatora = coordinator_table.id";
              ...
              <div>
                 ...
                 <div class="buttons">
                   <form action="detaljnijeTurnir_t.php" method="post">
                     <input
          ...
          <div class="update">
            ...
            <?php
              ...
              <div>
                 ...
                 <div class="buttons">
                   <form action="detaljnijeVest_t.php" method="post">
                     <input
