...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-brands">
          <?php
            include("conn.php");
            $query="SELECT ime, prezime, korisnicko_ime, profilna, uloga FROM `admin_table` 
    ...
    <div class="main-content">
        ...
        <main>
          ...
          <?php
              ...
              $sql="SELECT * FROM admin_table WHERE `korisnicko_ime`!='$_SESSION[AdminLoginId]' ";
        ...
        <table class="table">
                <tbody>
                    <tr>
                        <td data-label="ID" style="width:4%"><?= $rows['id_admina'];?></td>
                        ...
                        <form action="updateAdmin.php" method="post" >
                            <input type="hidden" type="submit" name="id_admina" placeholder="Dodaj" value="<?= $rows['id_admina'];?>">
                            <button
                                type="submit" name="update_admin"
                        ...
                        <form action="code.php" method="post">
                            <input type="hidden" type="submit" name="delete_admin_id" placeholder="Izbriši" value="<?= $rows['id_admina'];?>">
                            <input type="hidden" type="submit" name="user_email" placeholder="Email" value="<?= $rows['email'];?>">
                            <button
                                type="submit" name="delete_admin" onclick="return deleteAdmin()"
                ...
                <script>
                    function deleteAdmin() {
                      var data = confirm("Da li ste sigurni da želite izbrisati administratora?");
                      if(data == true) {
                        return true;
                      } else {
                        return false;
            ...
            <?php
                // PAGINATION
                // $pr_query = "SELECT * FROM admin_table";
            ...
            <?php
                // if($page>=2)
                // {
                //     echo "<a href='admini.php?page=".($page-1)."' class='btn-pagination'>&laquo;</a>";
                // }
                //
                ...
                //     if ($i == $page)
                //     {
                //         echo "<a class = 'btn-pagination active' href='admini.php?page=".$i."'>".$i." </a>";
                //     }
                //
                //     else
                //     {
                //         echo "<a href='admini.php?page=".$i."' class='btn-pagination'>$i</a>";
                //     }
                // }
                //
                // if($page<$total_page)
                // {
                //     echo "<a href='admini.php?page=".($page+1)."' class='btn-pagination'>&raquo;</a>";
                // }
            ?>
            </div>
        </main>
