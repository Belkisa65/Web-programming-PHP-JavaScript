        ...
        <main>
          <div class="update">
              ...
              <div class="contact-form-text">
                  <img src="<?php echo $rows['profilna']?>" alt="Profilna" style="box-shadow: 0px 2px 5px rgba(0,0,0,0.3); outline: 3px solid lightgray;">
              </div>
              <form role="form" action="code.php" method="post" enctype="multipart/form-data">
                  <div class="contact-form-text">
                    ...
                    <button type="submit" name="snimi_avatar" style="font-weight: 400; font-size: 14px;background: #1597BB;width:100px;">
                      Snimi
                    </button>
                    <a href="mojprofil.php" style="font-weight: 400; color: white; display: inline-block; width:100px;height: 39px;text-align: center;
