          ...
          <div class="update">
              ...
              <form role="form" action="code.php" method="post" enctype="multipart/form-data">
                  <div class="contact-form-text">
                    ...
                    <button type="submit" name="snimi_avatar_t" style="font-weight: 400; font-size: 14px;background: #1597BB;width:100px;">
                      Snimi
                    </button>
                    <a href="mojprofil_takmicar.php" style="font-weight: 400; color: white; display: inline-block; width:100px;height: 39px;text-align: center;
