...
<body>
    ...
    <div class="main-content">
        ...
        <main>
          <div class="update">
                <h2>Dodajte novog koordinatora</h2>
                <div class="contact-form-text">
                    <form action="code.php" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="contact-form-text">
                            <label for="pol" style="color: black;">Uloga:</label>
                            <select id="uloga" name="uloga" required>
                                <option value="Trener">Koordinator</option>
                            </select>
                        </div>
                        <a href="koordinatori.php" style="color: white; display: inline-block; width:100px; height:40px; text-align: center;
                        ...
                        <button type="submit" name="addCoordinator" style="background: #1597BB; width:100px;">
                          Dodaj
                        </button>
                    </form>
                </div>
