...
<body>
    ...
    <div class="main-content">
        ...
        <main>
          <div class="update">
                <h2>Dodajte novog administratora</h2>
                <div class="contact-form-text">
                    <form action="code.php" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <a href="admini.php" style="color: white; display: inline-block; width:100px; height:40px; text-align: center;
                        padding-top: 10px; margin-left:20px; background:#FF4646; font-size: 15px;">
                          Odustani
                        </a>
                        <button type="submit" name="addAdmin" style="background: #1597BB; width:100px;">
                          Dodaj
                        </button>
                    </form>
                </div>
