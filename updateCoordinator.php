    ...
    <div class="main-content">
        ...
        <main>
          <div class="update">
            <?php
              include("conn.php");
              if(isset($_SESSION['id_koordinatora']))
              {
                  $id = $_SESSION['id_koordinatora'];
                  $sql="SELECT * FROM coordinator_table WHERE id='$id'";
            ...
            ?>
              ...
              <form action="code.php" method="post">
                ...
                <div class="contact-form-text">
                      <a href="koordinatori.php" style="color: white; display: inline-block; width:100px; height:41px; text-align: center;
                      padding-top: 10px; background: #FF4646; font-size: 15px;">
                          Odustani
                      </a>
                      <button type="submit" name="update_coor" style="background: #1597BB; width:100px;">
                          Ažuriraj
                      </button>
                </div>
                <?php
