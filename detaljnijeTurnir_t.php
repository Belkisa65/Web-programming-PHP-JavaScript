...
<body>
    ...
    <div class="main-content">
        ...
        <main>
          ...
          if(isset($_POST['detaljnije_t']))
          {
              $id_turnira = $_POST['id_turnira'];
              $sql="SELECT * FROM turniri WHERE id_turnira = '$id_turnira'";
          ...
          <div class="update">
            <h1 style="padding-bottom:20px;padding-top: 20px;">Turniri</h1>
              <h2 style="padding-bottom: 10px;"><?php echo $rows['naziv']?></h2>
              <p  style="font-size: 14px; margin-left: 20px;">Kategorija: <?php echo $rows['naziv']?></p>
              <p style="font-size: 14px; margin-left: 20px;">Disciplina: <?php echo $rows['disciplina']?></p>
              ...
              <p style="margin-left: 20px; padding-bottom: 20px; padding-top: 20px;"> <?php echo $rows['opis']?></p>
          </div>
          <?php
            }
          }
